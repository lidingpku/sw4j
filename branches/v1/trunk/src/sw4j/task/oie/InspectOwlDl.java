...
public class InspectOwlDl extends AbstractTaskDesc{
	...
	public Resource getOwlSpecies(){
		return 	m_ontmodel_all.getOWLLanguageLevel(null);
		//return getReasonerAll().getSpecies();
	}
...
*/	
	...
	public Model getModelAll_deduction() {
		if (null==m_model_all_deduction){
			try {
				m_model_all_deduction = ToolJena.model_createDeductiveClosure(null, m_ontmodel_all);
